...
class TrainLoss(nn.Module):
    ...
    def forward(self, masked_pred_epsX, masked_pred_epsE, pred_y, true_epsX, true_epsE, true_y, log: bool):
        ...
        #     mse += self.train_node_mse(masked_pred_epsX, true_epsX)
        #     print("has node loss")
        # if true_epsE.numel() > 0:
        #     mse +=  self.train_edge_mse(masked_pred_epsE, true_epsE)
        #     print("has edge loss")
        # if true_y.numel() > 0:
        #     mse += self.train_y_mse(pred_y, true_y)
        #     print("has global loss")
